package com.orbitalhq.spring.http.client.config

import com.orbitalhq.spring.http.client.VyneHttpClient
import com.orbitalhq.spring.http.client.secure.OAuthClientCredentialsRestTemplateInterceptor
