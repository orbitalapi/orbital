...
export function ListItemGood({children}) {
  return (
    <li className="flex items-start space-x-4 before:content-none pl-0">
      <div
        className="mt-1.5 w-4 h-4 rounded-full bg-green-600 text-white flex items-center justify-center ring-2 ring-green-600">
...
export function ListItemBad({children}) {
  return (
    <li className="flex items-start space-x-4 before:content-none pl-0">
      <div
        className="mt-1.5 w-4 h-4 rounded-full bg-red-400 text-white flex items-center justify-center ring-2 ring-red-400">
