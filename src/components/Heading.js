...
// Not sure what this page is, or what it does.
// But, if we remove it, the build breaks.  Can't work out why.
    ...
    >
      {!hidden && (
        ...
        >
          &#8203;
          <div
            className="w-6 h-6 text-slate-400 ring-1 ring-slate-900/5 rounded-md shadow-sm flex items-center justify-center hover:ring-slate-900/10 hover:shadow hover:text-slate-700 dark:bg-slate-700 dark:text-slate-300 dark:shadow-none dark:ring-0">
