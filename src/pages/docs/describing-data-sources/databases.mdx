...
<Callout type='note' title='Before you continue...'>
   ...
   Before you run through this guide, make sure you've [added a database connection](../connecting-data-sources/connecting-a-database) for the table you want to connect.
