...
It's common to store your [core taxonomy](./overview#your-core-taxonomy), existing API specs (such as [OpenApi](../describing-data-sources/open-api) or [Protobuf](../describing-data-sources/protobuf)), or [database definitions](../describing-data-sources/databases)
