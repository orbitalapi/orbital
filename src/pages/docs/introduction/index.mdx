...
export const meta = {
  title: 'Overview',
  description: 'Orbital automates API integration, and provides rich data discovery, so you can spend less time plumbing, and more time building.'
}
...
Orbital allows consumers to ask for the data they need, without specifying how to fetch it.  Orbital generates the integration on-the-fly, using [Taxi](https://taxilang.org)
