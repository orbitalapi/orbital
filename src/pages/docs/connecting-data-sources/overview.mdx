...
These tags provide
In practice, these tags are actually semantic types, defined using [Taxi](/docs/connecting-data-sources/using-taxi).
...
For more information, follow our guides on using [OpenApi](/docs/connecting-data-sources/using-open-api) or [Protobuf](/docs/connecting-data-sources/using-protobuf) to describe your data sources.

#### Using Taxi
Another option is authoring your API specs directly in [Taxi](/docs/connecting-data-sources/using-taxi):
