...
description: Configuring Orbital to require authentication through OpenID Connect
---
...
<Callout type="note" title="Quick tip">
   ...
   We provide a full tutorial on securing Orbital with Keycloak - a popular
