...
out-of-the box with Orbital - so you get all the benefit of shared models, without the overhead associated with
...
<Callout title='Best practice recommendation' type='note'>
