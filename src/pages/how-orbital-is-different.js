            ...
            <div
              ...
              <div className="lg:row-start-2 lg:max-w-md">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-300">
                  Powerful enterprise integration features, redesigned to delight engineers and fit snugly in their
                  existing tooling and workflows.
                  <br/><br/>
                  As well as protection from breaking changes, Orbital offers a complete set of features to change your
                  integration game.
                </p>
              </div>
              <div
