...
<BlogImageWithCaption src={untypedDiagram} caption={`3 systems, but without any hints as to how it all relates`} wide  voyagerLink={`DCb8cYYKmj`}  />
...
<BlogImageWithCaption src={withSemanticTypes} caption={`By embedding semantic types, we can infer how data relates`} wide voyagerLink={`ChLGny26S6`} />
