...
<ImageWithCaption src={FilmsDbAndApi.src} voyagerLink='qBw38GjhQe' wide></ImageWithCaption>
...
<ImageWithCaption src={QueryExecutionPlan.src} wide
                  caption='A query execution plan, showing which systems are orchestrated for this query'></ImageWithCaption>
...
<ImageWithCaption src={QuerySequenceDiagram.src} wide
                  caption='Orbital generates sequence diagrams showing call level flow of data between systems'></ImageWithCaption>
...
<ImageWithCaption src={ValueLineage.src} wide
                  caption='The full on how each individual value was derived'></ImageWithCaption>
