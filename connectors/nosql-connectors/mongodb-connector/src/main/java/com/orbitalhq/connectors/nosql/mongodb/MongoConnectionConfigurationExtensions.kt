...
val MongoConnectionConfiguration.connectionString: ConnectionString
   get() {
      val connectionString =
         this.connectionParameters.valueOrThrowNiceMessage(MongoConnection.Parameters.CONNECTION_STRING.templateParamName)
...
val MongoConnectionConfiguration.database: String
   get() {
      return this.connectionString.database
         ?: this.connectionParameters.valueOrThrowNiceMessage(MongoConnection.Parameters.DB_NAME.templateParamName)
   }
