...
WithDefaultDocs.story = {
  name: "with default docs",
};

export const WithoutDefaultDocs = () => {
  return {
    template: `<div style="padding: 20px"><app-description-editor [descriptionSource]="type"></app-description-editor></div>`,
    props: {
      type: typeWithoutDoc,
...
WithoutDefaultDocs.story = {
  name: "without default docs",
};
