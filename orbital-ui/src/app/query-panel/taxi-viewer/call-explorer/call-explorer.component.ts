  ...
  template: `
    <div class="toolbar" *ngIf="!onlyShowQueryPlan">
      <tui-segmented size="s">
        ...
        <label><input name="radio" type="radio" value="trace" [(ngModel)]="displayMode"><app-svg-icon [width]="22" [height]="22" [strokeWidth]="1.5" tabler="arrows-right-left"></app-svg-icon>Trace <tui-badge size="s" appearance="info">Beta</tui-badge></label>
      </tui-segmented>
