...
class TypedEnumValue(override val type: Type, private val enumValue: EnumValue, private val typeCache: TypeCache) : TypedInstance {
   ...
   override fun withTypeAlias(typeAlias: Type): TypedInstance {
      return TypedEnumValue(typeAlias, enumValue, typeCache)
   }
