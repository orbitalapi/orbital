         ...
         val attributeInstances = type.attributes
            ...
            .map { (attributeName, field: Field) ->
               ...
               if (valueFromMap != null) {
                  attributeName to doParse(attributeType, mapOf(attributeName to valueFromMap), field.resolveType(schema).isCollection, conversionService, source = source, format = field.format ?: attributeType.formatAndZoneOffset)
               } else {
