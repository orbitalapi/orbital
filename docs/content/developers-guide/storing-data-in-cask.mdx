...
<a href="/assets/customers.csv" download>customers.csv</a>&nbsp;<a href="/assets/purchases.csv" download>purchases.csv</a>

Inside the csv files, the data will look like this:

<Tabs tabsNav={["customers.csv", "purchases.csv"]}>
<TabsContent>
...
<Tabs tabsNav={["CustomerRecord.taxi", "PurchaseRecord.taxi"]}>
<TabsContent>
...
<Tabs tabsNav={["/schemas", "/custom-path"]}>
<TabsContent>
