...
<Callout title='Related links' type='info'>
   ...
   * Exploring APIs in the data catalog
   * Describing REST APIs in Taxi
...
To keep things simple in our demo, the protobuf message is available one of our APIs.  You can view the protobuf yourself by clicking on [http://localhost:9091/proto](http://localhost:9091/proto).
