...
To get started, click "Add a data source" on the home page of Vyne, or navigate to [http://localhost:9022/schema-importer](http://localhost:9022/schema-importer)
