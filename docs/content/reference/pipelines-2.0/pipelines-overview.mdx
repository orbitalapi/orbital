...
| `vyne.pipelines.query-mode`     | `EMBEDDED` or `REMOTE`. Defines whether to use an embedded Vyne instance or to call a remote Vyne instance over HTTP.      |
...
Click on the Pipeline Manager in the left-hand navigation bar, and complete the form
to create a pipeline.

![](./pipeline-wizard-empty.png)
