...
Clustering of Vyne server instances allows for distribution of CPU intensive tasks, especially projections.
...
| `aws` | Vyne services attempt use AWS metadata to discover other cluster nodes   |
