...
import { HeadingWrapper, HttpButton } from "../components/http-buttons"

A Swagger UI is available at `http://pipelies-orchestrator:9600/swagger-ui.html`

## <HeadingWrapper><HttpButton /> Get Pipelines</HeadingWrapper>
...
## <HeadingWrapper><HttpButton isPost={true} /> Submit a pipeline</HeadingWrapper>
...
## <HeadingWrapper><HttpButton /> Get the Runners</HeadingWrapper>
