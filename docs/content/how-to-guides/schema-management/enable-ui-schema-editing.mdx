...
<Callout type='hint' title='Before you begin'>
   ...
   If not, you might want to follow our guide on <Link to={""}>creating a new taxi project</Link> first.
 ...
 * If not, copy and paste the below section into your config file, setting the `path` to th
