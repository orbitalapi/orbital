...
For full specification, including supported database drivers and their connection details, read <Link to='/reference/connections/connections-config/'>Managing Connections</Link>.
