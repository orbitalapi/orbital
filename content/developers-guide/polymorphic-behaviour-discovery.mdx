---
title: Discovering and calling services at runtime
description: >-
...
Vyne lets you look up & invoke services at runtime.  In this walkthrough, we'll continue with our compliance engine from our <Link to="../exploring-vynes-problem-solving">previous</Link>, and deploy a new rule, observing how Vyne automatically adjusts to include it our calls.
