...
<a href="/assets/customers.csv">customers.csv</a>

<a href="/assets/purchases.csv">purchases.csv</a>
...
Read more about semantic types <Link to="../../overview/semantic-data-intro.md">here</Link>.
...
You can find out more about our query syntax at <Link to="../querying-with-vyne/">Querying with Vyne</Link>.
