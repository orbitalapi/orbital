...
* <a href="#automating-api-integration">Exploring Vyne's automated API integrations</a>
* <a href="#building-a-standalone-taxonomy">Building a standalone
  taxonomy</a>
* <a href="#building-streaming-data-solutions">Building streaming data solutions</a>
* <a href="#ingesting-and-querying-file-based-data">Ingesting and querying flat-based data (CSV, Json, Xml, etc)</a>
...
We have a dedicated guide to building and publishing a taxonomy, which you can follow along with <Link to="../../running-a-local-taxonomy-editor-environment/README">here</Link>.
...
We have a dedicated guide to storing and querying flat-file data, which you can follow along with <Link to="../../casks/cask-server">here</Link>.
