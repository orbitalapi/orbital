---
title: Querying casks through operations
description: >-
...
See this section of <Link to="../README#query-behaviours">Configuration</Link>.
...
<Discourage>
  We've deprecated this annotation, as we feel it's not very self-documenting.
  It will be replaced by new annotations - `@FindOne` and `@FindMany` in an
  upcoming release.
</Discourage>
