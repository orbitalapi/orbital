---
title: Starting Vyne
description: Learn how to run Vyne
---
...
There's a sample file in there to get you started. You can delete the contents of that directory, and use <Link to="../setting-up-visual-studio-code">Visual Studio code</Link> to author your own taxonomy files.
...
<Tabs tabsNav={["Linux & Mac", "Windows CMD", "Windows Powershell"]}>
<TabsContent>
...
<Hint>
  If you are setting `TAXONOMY_HOME` in the `.env` file, be sure not to place
  your path inside of quotation marks. However, if you must use quotation marks,
  be sure to double all your backslashes.
</Hint>
