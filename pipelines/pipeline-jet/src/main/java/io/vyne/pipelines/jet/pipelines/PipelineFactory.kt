...
class PipelineFactory(
   ...
   private fun buildTransformStage(
      ...
      jetPipelineBuilder: StreamStage<MessageContentProvider>
   ): StreamStage<out MessageContentProvider> {
   ...
   private fun <I : PipelineTransportSpec, O : PipelineTransportSpec> buildSink(
      ...
      jetPipelineWithTransformation: StreamStage<out MessageContentProvider>
   ) {
