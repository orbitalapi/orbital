//https://github.com/reactor/reactor-kafka/blob/master/src/test/java/reactor/kafka/AbstractKafkaTest.java
/*
...
public abstract class AbstractKafkaTest {
   ...
   private final List<List<String>> expectedMessages = new ArrayList<>(partitions);
   ...
   protected SenderRecord<String, String, Integer> toSenderRecord(String destTopic, ConsumerRecord<String, String> record, Integer correlationMetadata) {
