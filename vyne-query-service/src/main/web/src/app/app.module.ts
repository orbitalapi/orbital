...
export const routerModule = RouterModule.forRoot(
  [
    ...
    // {
    //   path: 'query/editor', component: QueryPanelComponent, canActivate: [AuthGuard],
    ...
    {
      path: 'query-history/:queryResponseId',
      component: QueryHistoryComponent,
      canActivate: [AuthGuard],
      data: { requiredAuthority: VynePrivileges.ViewHistoricQueryResults }
    },
    {
